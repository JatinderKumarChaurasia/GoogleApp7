...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes(){
        ...
        try {
            ...
            {
                JSONObject object1 = features.getJSONObject(i);
                JSONObject object2 = object1.getJSONObject("properties");
                double mag = object2.getDouble("mag");
                String place = object2.getString("place");
                Long timeInMilliseconds = object2.getLong("time");
                String url = object2.getString("url");
                EarthQuake earthQuake = new EarthQuake(place,mag,timeInMilliseconds,url);
